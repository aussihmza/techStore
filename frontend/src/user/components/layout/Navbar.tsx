...
import { navLinks } from "@/user/lib/products";
import { useStore } from "@/context/StoreContext";
import SearchBar from "@/user/components/layout/SearchBar";
import { CartIcon, HeartIcon, UserIcon } from "@/user/components/ui/icons";
