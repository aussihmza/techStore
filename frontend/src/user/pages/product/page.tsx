...
import { getCategoriesApi, toShopCategory } from "@/user/api/categories";
import {
  getProductByIdApi,
  getProductsApi,
  toProductCard,
  toProductDetail,
} from "@/user/api/products";
import ProductGallery from "@/user/components/product/ProductGallery";
import ProductInfo from "@/user/components/product/ProductInfo";
import ProductFeatures from "@/user/components/product/ProductFeatures";
import ProductReviews from "@/user/components/product/ProductReviews";
import RelatedProducts from "@/user/components/product/RelatedProducts";
